...
try:
    db_arauz = server.create('arauz_provincias_ecu')
except:
    db_arauz = server['arauz_provincias_ecu']
               
try:
    db_lasso = server.create('lasso_provincias_ecu')
except:
    db_lasso = server['lasso_provincias_ecu']

    
'''===============LOCATIONS=============='''    
# Geolocalización de las provincias del Ecuador
twitterStream.filter(locations=[-81.0123,-5.0084,-75.2074,1.467])  

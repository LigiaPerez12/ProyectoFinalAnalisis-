...
try:
    db = server.create('lasso_portoviejo')
except:
    db = server['lasso_portoviejo']

    
'''===============LOCATIONS=============='''    
# Geolocalización de Portoviejo
twitterStream.filter(locations=[-80.5625,-1.125509,-80.316762,-0.956622])

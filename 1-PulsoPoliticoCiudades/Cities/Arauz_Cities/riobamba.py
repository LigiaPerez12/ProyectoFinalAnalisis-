...
try:
    db = server.create('arauz_riobamba')
except:
    db = server['arauz_riobamba']

    
'''===============LOCATIONS=============='''    
# Geolocalización de Riobamba
twitterStream.filter(locations=[-78.723592,-1.710588,-78.595487,-1.633713])

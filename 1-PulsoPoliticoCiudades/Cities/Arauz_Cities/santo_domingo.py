...
try:
    db = server.create('arauz_santo_domingocity')
except:
    db = server['arauz_santo_domingocity']

    
'''===============LOCATIONS=============='''    
# Geolocalización de Santo Domingo
twitterStream.filter(locations=[-79.5484,-0.6804,-78.8094,-0.0899])

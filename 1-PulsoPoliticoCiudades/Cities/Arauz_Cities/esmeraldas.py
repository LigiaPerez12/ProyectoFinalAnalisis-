...
try:
    db = server.create('arauz_esmeraldas_city')
except:
    db = server['arauz_esmeraldas_city']

    
'''===============LOCATIONS=============='''    
# Geolocalización de Esmeraldas
twitterStream.filter(locations=[-79.8376,0.6051,-79.4046,1.0486])
